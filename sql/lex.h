...
static const SYMBOL symbols[] = {
    ...
    */
    ...
    {SYM_H("SET_HASH_JOIN_DISTRIBUTION", SET_HASH_JOIN_DISTRIBUTION)},
    {SYM_H("FORCE_HASH_JOIN", FORCE_HASH_JOIN)},
    {SYM_H("HJ_BUFFER_SIZE", HJ_BUFFER_SIZE)},
    {SYM_H("HASH_JOIN_ACTUAL_ROWS", HASH_JOIN_ACTUAL_ROWS)},
    {SYM_H("HASH_JOIN_MIN_BUFFER_FACTOR", HASH_JOIN_MIN_BUFFER_FACTOR)},
    {SYM_H("HASH_JOIN_WEIGHT_GAP_FACTOR", HASH_JOIN_WEIGHT_GAP_FACTOR)}};
